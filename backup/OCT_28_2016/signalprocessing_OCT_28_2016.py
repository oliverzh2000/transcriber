...
def dft_peak_x(pt1, pt2, pt3, samples, iterations):
    """
    ...
    if iterations == 0:
        ...
        if new_vert_ismax and left_pt[0] < new_vert_x < mid_pt[0]:
            return dft_peak_x(left_pt, new_pt, mid_pt, samples, iterations)
        else:
            return dft_peak_x(right_pt, new_pt, mid_pt, samples, iterations)
